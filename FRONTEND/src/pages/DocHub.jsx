    ...
    <PageContainer>
      <div className="flex flex-col gap-6 text-left max-w-4xl mx-auto mt-4">
        ...
        <div>
          ...
          <h1 className="text-3xl font-semibold tracking-tighter mt-4">DocHub</h1>
          <p className="text-sm text-[#6B6B6B] mt-1">
            Interactive AI document generation (Rental Agreement, Legal Notice, Affidavit).
          </p>
        </div>
        ...
        <Card className="p-10 flex flex-col items-center text-center gap-6 justify-center bg-[#FCFCFB] h-[360px]" hoverEffect={false}>
          ...
          <div className="flex flex-col gap-2 max-w-sm">
            ...
            <p className="text-xs text-[#6B6B6B] leading-relaxed">
              AI-assisted legal document template forms, rich text previews, and PDF/DOCX export options will be built in Sprint 3.
            </p>
          </div>
          <Link to="/dashboard">
